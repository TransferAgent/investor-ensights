...
<img src="/beast-05-zk-network.png" alt="Tableicity Cap Table Dashboard showing SHA-256 hashed stakeholder identities, ZK-Proof verification network, and 30-minute auditor reveal access control for {{city}}, {{state_code}} founders." style="width: 100%; border-radius: 12px; display: block;" />
</figure>
...
<p>Tableicity is currently available to founders and CFOs across all 50 US states, with dedicated onboarding support for companies in the {{city}} metropolitan area.</p>`;
    ...
    await db.insert(knowledgeTemplates).values({
      ...
      ogImageUrl: "https://www.tableicity.com/beast-05-zk-network.png",
      isActive: true,
    });
  }
  ...
  for (const city of realCities) {
    ...
    await db.insert(knowledgeArticles).values({
      ...
      ogImageUrl: activeTemplate.ogImageUrl || "https://www.tableicity.com/beast-05-zk-network.png",
