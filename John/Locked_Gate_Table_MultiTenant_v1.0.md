...
- **MT-1:** **CLOSED 2026-05-09.** Tenant-aware DB client live. 4 new files (lib/tenant/*, server/db.ts now re-exports), 1 modified (lib/db.ts). 239 lines. App Builder + Architect signed off; awaiting Tableicity Custodian visual spot-check before MT-2.
- **MT-2:** **OPEN — awaiting Conductor "go" signal to begin.** Pre-gate dump required: `John/Dump_MT2_Pre.dump`.
- **MT-3 through MT-9:** Not yet open. Do not start.
